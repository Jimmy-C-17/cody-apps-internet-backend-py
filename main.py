...
app.add_middleware(
    ...
    allow_origins=["http://localhost:4200", "http://localhost:8080", "http://127.0.0.1:4200"."https://cody-apps-internet-frontend-ng-244n.vercel.app","https://cody-apps-internet-frontend-ng-244n-fzk32un97-jimmy-0ebb.vercel.app"], 
